...
```
/dna:tokens ./references/dashboard.png
/dna:tokens ./notes/measured-values.md
```

> Next: prove the tokens with `/dna:build` (rebuild the reference in a lab), or
> run everything end-to-end with `/dna:extract`.
